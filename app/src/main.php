...
<section class="testimonials">
    <div class="container">
        ...
        <div class="main-wrapper">
            <div class="row justify-content-end justify-content-lg-between align-items-lg-end align-items-xl-start">
                ...
                <div class="gmb-wrapper">
                    ...
                    <div class="row no-gutters p-3 text-white justify-content-between">
                        ...
                        <div class="col-auto d-flex align-items-center">
                            ...
                            <a href="#" class="px-2">
                                <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M2.05009 0.24028C0.583522 0.97111 0.218651 2.88073 1.3089 4.11936C1.98697 4.88961 3.14942 5.14587 4.08702 4.73178C6.06284 3.85902 6.08336 1.08144 4.12062 0.194058C3.51229 -0.0810019 2.65651 -0.061932 2.05009 0.24028ZM14.5584 6.56957C13.7244 6.85389 12.9814 7.3241 12.4775 7.88639L12.0471 8.36668L11.9895 7.88639C11.9577 7.62232 11.9314 7.253 11.931 7.06566L11.9302 6.72513H9.93239H7.93459V13.4904V20.2557H9.93239H11.9302L11.937 18.0081C11.9408 16.772 11.9731 14.8798 12.0089 13.8031C12.0719 11.9055 12.0813 11.8329 12.3149 11.4345C12.6449 10.8715 13.2043 10.3883 13.6731 10.2615C13.8882 10.2033 14.3548 10.1742 14.71 10.1968C15.5711 10.2514 16.0383 10.5537 16.4222 11.3045C16.6897 11.8274 16.6966 11.8747 16.7566 13.6179C16.7903 14.5966 16.8215 16.4904 16.8259 17.8265L16.8339 20.2557H18.8771H20.9203L20.9189 15.4201C20.9178 11.4838 20.8928 10.4791 20.784 10.0177C20.35 8.17725 19.1407 6.89766 17.4611 6.50174C16.5742 6.2927 15.2821 6.32284 14.5584 6.56957ZM1.0926 6.78679C1.05863 6.82066 1.03248 9.86503 1.0343 13.5521L1.03766 20.2557H3.12399H5.21033V13.4904V6.72513H3.18229C2.06679 6.72513 1.12647 6.75282 1.0926 6.78679Z" fill="white" />
                                </svg>
                            </a>
                            <a href="#" class="px-2">
