...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-52116368-2"></script>
	<script>
		...
		gtag('js', new Date());
		gtag('config', 'AW-10940119318');
		gtag('config', 'UA-52116368-2');
	</script>

	<!-- Global site tag (gtag.js) - Google Ads -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=AW-10940119318"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag() {
			dataLayer.push(arguments);
